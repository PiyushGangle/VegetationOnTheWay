...
-- Generated 2020.06.12 15:01:17 by ADMIN
-- This script can be run in sqlplus as the owner of the Oracle Apex owner.
begin
    wwv_flow_api.set_security_group_id(p_security_group_id=>4776424410568498);
end;
/
----------------
-- W O R K S P A C E
...
wwv_flow_fnd_user_api.create_company (
  p_id                           => 4776514366568598,
  p_provisioning_company_id      => 4776424410568498,
  p_short_name                   => 'ADMIN',
...
wwv_flow_fnd_user_api.create_fnd_user (
  p_user_id      => '4776330605568498',
  p_user_name    => 'ADMIN',
  p_first_name   => '',
  p_last_name    => '',
  p_description  => '',
  p_email_address=> 'pyushgang@gmail.com',
  p_web_password => '2742FDBB1E3210F7452122F1E1F92E91',
  p_web_password_format => 'HEX_ENCODED_DIGEST_V2',
  p_group_ids    => '',
  p_developer_privs=> 'ADMIN:CREATE:DATA_LOADER:EDIT:HELP:MONITOR:SQL',
  p_default_schema=> 'ADMIN',
  p_account_locked=> 'N',
  p_account_expiry=> to_date('202006120942','YYYYMMDDHH24MI'),
