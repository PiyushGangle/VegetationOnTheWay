    ...
    <body>
        ...
        <div class="outerdiv">
            ...
            <div class="headerdiv">
                ...
                <div class="projecttitlediv" style="font-size: 20px;">
                    Vegetation On-The-Way : : My-Rent-Order
            ...
            <div class="datadiv" style="margin-top: 7% ;overflow: scroll; overflow-x: hidden;width: 80%; height: 75%; ">
                ...
                <%
                    ...
                    ArrayList aduration = null;

                    Class.forName("oracle.jdbc.driver.OracleDriver");
                    Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "admin", "admin");
                    PreparedStatement ps = con.prepareStatement("select id,pname,quantity,amount,pdate,checkoutid,duration from checkout where email=? and type=?");
                    ps.setString(1, email);
                    ps.setString(2, "RENT");
                    ResultSet rs = ps.executeQuery();
                    String id = null, name = null, quantity = null, duration = null;
                    Date date = null;
                    ...
                    while (rs.next()) {
                        ...
                        aduration = new ArrayList(Arrays.asList(duration.split(",")));
                        ...
                        for (int i = 0; i < aname.size(); i++) {
                            ...
                            out.println("<h4> DURATION: " + aduration.get(i) + "/DAYS" + "</h4>");
                            out.println("</td>");
                        }
                        ...
                        out.println("<tr><td><h4>RENT ORDER DATE : " + date + "</h4></td></tr>");
                        out.println("<tr><td><a href='cancelorder1.jsp?checkoutid= " + rs.getInt("checkoutid") + "' > Cancel Order </a><tr><td>");
