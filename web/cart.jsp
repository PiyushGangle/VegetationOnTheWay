                ...
                <%
                    ...
                    if (hs.getAttribute("name") != null) {
                        ...
                        try {
                            ...
                            PreparedStatement ps = con.prepareStatement("select id,quantity from buy where email=?");
                            ...
                            while (rs.next()) {
                                ...
                                while (rs1.next()) {
                                    ...
                                    money += Integer.parseInt(rs1.getString("price")) * quantity;
                                    out.println("<a href='removecart.jsp?id=" + id + "'>Remove</a>");
                                    out.println("<a href='updatecart.jsp?id=" + id + "'>Update Order</a>");
                                    out.println("</td>");
                            ...
                            out.println("Total Amount " + money);
                            HttpSession hs2 = request.getSession();
                            hs2.setAttribute("money", money);
                            out.println("<a href='checkout.jsp'><input type='submit' value='PlaceOrder' /></a>");
